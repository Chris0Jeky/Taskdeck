...
Home, nor the Activity view's board selector ordering (`useActivityQuery`). That is a return to pre-guard behaviour rather than a new choice; making board recency reflect
