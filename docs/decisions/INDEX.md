...
| [0014](ADR-0014-platform-expansion-four-pillars.md) | Platform Expansion - Four Pillars | Proposed — PARKED (de-scoped by the 2026-06-13 archive pivot; see ADR-0038) | 2026-03-29 |
...
| [0020](ADR-0020-plugin-extension-architecture.md) | Plugin/Extension Architecture RFC and Sandboxing Constraints | Proposed — PARKED (de-scoped by the 2026-06-13 archive pivot; see ADR-0038) | 2026-04-01 |
...
| [0023](ADR-0023-sqlite-to-postgresql-migration-strategy.md) | SQLite-to-PostgreSQL Migration Strategy | Accepted — PARKED (PostgreSQL target de-scoped; SQLite permanent) | 2026-04-09 |
...
| [0026](ADR-0026-cloud-cost-observability.md) | Cloud Cost Observability and Budget Guardrails | Accepted — PARKED (cloud deployment de-scoped) | 2026-04-09 |
| [0027](ADR-0027-cloud-target-topology-autoscaling.md) | Cloud Target Topology and Autoscaling Reference Architecture | Proposed — PARKED (entire cloud/multi-instance topology de-scoped; see ADR-0038) | 2026-04-09 |
| [0028](ADR-0028-staged-deployment-bluegreen-canary.md) | Staged Deployment - Blue/Green with Canary Verification | Accepted — PARKED (cloud deployment de-scoped) | 2026-04-09 |
...
| [0057](ADR-0057-user-sovereign-delegated-authority.md) | User-Sovereign Delegated Authority for Automation | Accepted (maintainer ruling 2026-08-24, recorded on `#2011`, with an explicit openness caveat; direction only - GP-06, ADR-0003, ADR-0017 and ADR-0056 stay fully operative and no auto-approval surface may be built until implementation is separately gated) | 2026-08-23 |
...
| [0060](ADR-0060-canonical-work-model-and-compatibility-path.md) | Canonical Work Model and Compatibility Path | Accepted (2026-08-29, #2084); archive/depth and explicit assignment-import clarifications recorded 2026-09-10/11 | 2026-08-26 |
...
| [0062](ADR-0062-custom-fields-aggregates-and-threshold-rules.md) | Custom Fields, Aggregates, and Threshold Rules | Accepted (2026-08-29, #2091); timing amendments 2026-08-30/09-06; effort-minutes ruling 2026-09-11 on #2093 | 2026-08-26 |
...
| [0065](ADR-0065-context-fabric-capture-representation-processing.md) | Context Fabric — Durable Capture, Derived Representations, Semantic Candidates, and Capability-Based Processing | Accepted (confirmed 2026-08-30 with amendments — rulings first made under the maintainer's delegation on `#2254`, then confirmed the same day after the external audit of PR `#2280`; `SourceAsset` foundation, three capture state axes, producer principal and requested/effective intent, Worker Protocol v1-alpha, `IBlobStore` reference semantics, v0.4 gates A–D, risk-based CF-22 gate — see the ADR's *Amendments* section; CF-22 maintainer go recorded 2026-09-03 with the evidence report kept as the acceptance bar) | 2026-08-30 |
| [0066](ADR-0066-smart-ci-fabric-and-private-repository-runner-trust.md) | Smart CI Fabric and Private-Repository Runner Trust — go private for v0.3.0 on a personal GitHub Pro account; one stable `Smart CI / Required Gate`; base-ref control plane; fail-closed shadow planner; Linux semantic baseline + Windows compatibility contract; isolated no-secret self-hosted runners; storage first | Accepted (delegated rulings of 2026-08-30 confirmed by the maintainer on 2026-09-03 with the private-Pro approval-boundary amendment; nine rulings on CI-00 `#2324` stand; visibility, spend ceiling, branch protection and runner registration stay maintainer actions in `OUTSTANDING_TASKS.md` §J) | 2026-08-30 |
