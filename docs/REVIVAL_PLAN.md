...
- The **two-tier review gate** (#1269) applies: FULL tier (2 adversarial reviews + bots + aging) for anything touching the capture→proposal→apply loop, auth, or migrations; LIGHT tier for docs/config/UI-copy.
