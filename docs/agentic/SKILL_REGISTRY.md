...
| `taskdeck-pr-review-loop` | PR self-review, adversarial review, review comments, or bot comments. |
...
Claude skills under `.claude/skills/` mirror the Taskdeck workflows above and add Claude-oriented helpers such as `issue-to-pr`, `adversarial-review`, `pre-merge-gate`, and `docs-sweep`.
