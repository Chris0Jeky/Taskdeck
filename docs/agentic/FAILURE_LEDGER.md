...
| 2026-07-13 | pre_existing_noise | test/background-workers | #1334's full suite let a hosted LLM worker pre-claim a test row and a delayed presence join arrive after events were cleared | Keep the full run non-green and link exact evidence from the PR | Resolved by #1394/#1391 (worker isolation) on 2026-07-17; the delayed-presence-join half was fixed separately by #1366 (snapshot ordering) and #1371 (phase dr... | resolved |
