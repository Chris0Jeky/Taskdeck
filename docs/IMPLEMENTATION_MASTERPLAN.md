...
- **Release sequencing is unchanged.** No v0.1.2 tag exists. The open Priority I milestone tranche, maintainer deck acceptance, no-publish rehearsal, public-artifact verification, and manual ordinary-profile Windows acceptance remain ahead of a tag. ProjectV2 plus the milestone stay authoritative for the live queue.
