...
- **Infra / harness:** `#1352` fixed the systemic CI-Extended reusable-workflow permission failure (`#1330`, the deck-wide linchpin); `#1294` harness T3 region maps + skill diet (`#1291`); dependabot `#1351` / `#1349`.
