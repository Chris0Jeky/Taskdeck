...
- **Three review ceilings produced durable parked heads, not fix cascades.** `#1967`/PR `#2025` preserves the broader applied-proposal detail lineage at `a70f88ad`; its mixed-case proposal-identity blocker was extracted into the narrower merged PR `#2034`, while the broader detail/history acceptance remains open. `#2005`/PR `#2026` is preserved at `ab1db61e` with a free-form-label triage blocker; and `#1973`/PR `#2031` is preserved at `ecf44ea2` after its single fix round still left Paper capture history without a full detail surface and allowed a retained proposal hash to escape the archived read-only boundary. Resume from the issue comments and preserved branches, not by reopening or rewriting those PR heads.
