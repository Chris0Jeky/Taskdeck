...
- `GP-06 Review-First Automation Safety`
  ...
  - Risk tiers change review order and approval ergonomics, never the requirement for human approval followed by a separate explicit Apply. Batch approval remains limited to the reviewer's own live Low-risk proposals containing one to five card creations. Under the maintainer's 2026-09-06 D-4 ruling on #1307, batch Apply accepts live Approved proposals of any risk or operation shape, including shared-board proposals by other authors; board-less proposals still require ownership. Every item retains server-side authorization, policy and approved-revision checks, idempotency, transactional audit, and its own receipt. The 500-proposal cap and confirmation remain; partial success is reported per item, without rolling back successful siblings. Confidence never grants write authority.
