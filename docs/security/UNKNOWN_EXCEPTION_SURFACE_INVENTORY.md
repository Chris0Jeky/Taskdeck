...
- **R7 — CLOSED by `#2466` (merge `57df469e2`): the standalone CLI has a top-level boundary.**
  ...
  `backend/tests/Taskdeck.Cli.Tests/CliUnexpectedErrorSafetyTests.cs` (12 cases). The companion
