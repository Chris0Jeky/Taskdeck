...
- `analysis/`
  ...
  - includes `analysis/2026-08-30-acceleration-bundles-v0.5-v0.6/` — the validated, corrected head-start material for the v0.5 and v0.6 Context Fabric issues (per-issue architecture and child slices, contract-draft schemas checked by `scripts/context_fabric/check_contract_drafts.py`, reference candidates, diagrams; tracker `#2368`), beside the earlier `analysis/2026-08-30-acceleration-bundle/` (v0.3/v0.4) and `analysis/2026-08-30-context-fabric/` (ADR-0065 pack) records.
  ...
  - includes `analysis/2026-08-30-engineering-review/` — a dated reconciliation of the external security, quality, performance, modularity, and payment-gating bundle: reproducible metric drift, patch corrections, a deduplicated 20-brief issue map, and a non-normative entitlement-boundary primer.
  - includes `analysis/2026-08-30-acceleration-bundle/` — the v0.3/v0.4 acceleration bundle: the 2026-08-30 reconciliation (`RECONCILIATION.md`, `#2348`) and the 2026-09-02 re-pass (`HEAD_START.md`, `#2376`) with the archived blueprints, reference-only candidates and one validated head-start file per open milestone-4/5 target issue.
- `InReview/`
