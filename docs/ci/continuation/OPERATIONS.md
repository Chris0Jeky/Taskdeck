...
1. Resolve the conservative-contract edge cases tracked on #2336 before connecting admission: attempt gaps, unknown risk, explicit test inventory requirements, late baseline exposure and same-second recovery ordering. Unknown transitive inputs keep a task reuse-ineligible.
