...
| [PUBLIC_MIRROR_OPTIONS.md](PUBLIC_MIRROR_OPTIONS.md) | The SC-8 public release/source mirror: three options scored, the recommendation and its cost, the tag-triggered publishing mechanism, the no-publish rehearsal, and the maintainer's open questions (CI-16 `#2439`) |
