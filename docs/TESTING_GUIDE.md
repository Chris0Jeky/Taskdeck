...
- both reusable k6 workflows fail closed when the required summary is missing, empty, malformed, or lacks a k6 metrics object; their `always()` artifact uploads still preserve available diagnostics.
