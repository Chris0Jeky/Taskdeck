...
uncertain one: it says so and locks the selection control and Save until the
board reports write permission again, because the reads a Viewer can still
complete are not evidence that writing is allowed. Removed
