# Issue Execution Guide — historical stage record (2026-02 → 2026-05)

**Status: HISTORICAL.** Extracted verbatim from `docs/ISSUE_EXECUTION_GUIDE.md` on 2026-08-23
during the repository realignment. Every stage below is a delivered or closed wave; none is an
active issue-selection source. Active execution follows `docs/REVIVAL_PLAN.md` and the current
`docs/ISSUE_EXECUTION_GUIDE.md`.

---

## Priority Model (pre-revival tranche framing — retired)
