# Taskdeck STATUS history - 2026-02 to 2026-07 (HISTORICAL)

**Extracted 2026-08-23 from `docs/STATUS.md`. Non-authoritative.**

This file is a verbatim rotation of delivery history out of the live status document, performed
as part of the 2026-08-23 repository realignment (the standing `#1138` head-lean scope). Nothing
here was rewritten, corrected, or summarised - it is the text exactly as it stood in
`docs/STATUS.md` before the rotation, including claims that were later superseded or corrected.

- **Authoritative current state:** [`docs/STATUS.md`](../../STATUS.md)
- **Direction:** [`docs/strategy/PRODUCT_DIRECTION.md`](../../strategy/PRODUCT_DIRECTION.md)
- **Execution plan:** [`docs/REVIVAL_PLAN.md`](../../REVIVAL_PLAN.md)
- **Rule:** if anything in this file conflicts with an active doc, the active doc wins.

Contents, in the order the material appeared in `STATUS.md`:

1. Dated update blocks older than 2026-07-01 (2026-06-26 back to 2026-05-29)
2. Project Summary delivery waves (2026-05-16 back to 2026-04-25)
3. The dated delivery waves that sat inside the "Current constraints" list (2026-04-01 to 2026-04-25)
4. The 2026-02 to 2026-04 wave sections, including the pre-pivot "Phase Progress (Reconciled)" Phase 1-4 model
5. "Recently Resolved (This Cycle)" - a 2026-02 cycle record still carrying that title in 2026-08


---

## 1. Dated update blocks older than 2026-07-01 (from the STATUS.md update history)
...
## 2. Project Summary delivery waves (2026-05-16 to 2026-04-25)
...
## 3. "Current constraints" dated delivery waves (2026-04-01 to 2026-04-25)
...
- CI/hardening, frontend decomposition, ops, and documentation wave (2026-04-22, PRs `#914`--`#924`, 10 issues):
  ...
  - **DOC-08 data model reference with ERD** (`#875`/`#917`): `docs/architecture/DATA_MODEL.md`, a Mermaid ERD plus per-entity field tables covering relationships, field types, and constraints; cross-linked from 5 API docs (BOARDS, CAPTURE, CHAT, WEBHOOKS, AUTHENTICATION). Read the document itself for its current shape — the as-delivered line/entity counts were dropped here in `#1470` because a hand-maintained figure in a ledger rots silently
...
## 4. Wave sections, 2026-02 to 2026-04 (includes the pre-pivot Phase Progress model)
...
## 5. "Recently Resolved (This Cycle)" - a 2026-02 cycle record
