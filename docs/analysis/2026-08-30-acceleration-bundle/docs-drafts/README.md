...
| `TELEMETRY.md` | `docs/TELEMETRY.md` | `#1308` | **Blocked on the maintainer's Option A / Option B decision**; the local no-op / allowlist shape is a safe default, no transport is authorized |
