...
| `docs/archive/2026-02-25_inreview-repo-pack/REPO_PACK/.../PRODUCT_BRIEF.md` | capture MVP product definition | issue tracker `#199`, execution issues `#200` to `#211` | seeded |
| `docs/archive/2026-02-25_inreview-repo-pack/REPO_PACK/.../AUTONOMY_TRUST_MODEL.md` | trust model and autonomy boundaries | `README.md`, `docs/STATUS.md`, `docs/IMPLEMENTATION_MASTERPLAN.md` | promoted |
| `docs/archive/2026-02-25_inreview-repo-pack/REPO_PACK/.../CAPTURE_PIPELINE_SPEC.md` | domain/workflow model | `#200`, `#201`, `#203`, `#204` | seeded |
| `docs/archive/2026-02-25_inreview-repo-pack/REPO_PACK/.../API_SPEC_CAPTURE.md` | capture API contract | `#201` | seeded |
| `docs/archive/2026-02-25_inreview-repo-pack/REPO_PACK/.../LLM_TRIAGE_CONTRACT.md` | strict output schema and validation | `#205` | seeded |
| `docs/archive/2026-02-25_inreview-repo-pack/REPO_PACK/.../UX_SPEC.md` | inbox/capture/provenance UX | `#206` to `#209` | seeded |
| `docs/archive/2026-02-25_inreview-repo-pack/REPO_PACK/.../TESTING_AND_VERIFICATION_PLAN.md` | test/E2E/manual requirements | `#210`, `#211`, `docs/TESTING_GUIDE.md`, `docs/MANUAL_TEST_CHECKLIST.md` | promoted + seeded |
| `docs/archive/2026-02-25_inreview-repo-pack/REPO_PACK/.../SECURITY_PRIVACY.md` | capture privacy and trust controls | `#81`, `#156`, `#212` | seeded |
| `docs/archive/2026-02-25_inreview-repo-pack/REPO_PACK/.../ISSUE_SEEDS.md` | capture issue decomposition | `#199` to `#211`, `#218` to `#220` | seeded |
| `docs/archive/2026-02-25_inreview-repo-pack/REPO_PACK/.../PROMOTION_CHECKLIST.md` | canonical doc promotion rules | `#211`, active docs update discipline | promoted + seeded |
| `docs/archive/2026-02-25_inreview-repo-pack/REPO_PACK/.github/ISSUE_TEMPLATE/feature.yml` | feature issue structure | `.github/ISSUE_TEMPLATE/feature.md` | adapted/promoted |
...
| `docs/archive/2026-02-25_inreview-repo-pack/REPO_PACK/docs/analysis/taskdeck_testing_harness_improvement_pack_2026-02-23/` | testing-harness wave recommendations and CI guardrails | `docs/analysis/2026-02-23_testing-harness-synthesis.md`, issues `#254` to `#260` | promoted + seeded |
