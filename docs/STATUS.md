...
- **Infra / harness:** `#1352` fixed the systemic CI-Extended reusable-workflow permission `startup_failure` (`#1330`) — the linchpin that unblocked the whole deck; `#1294` harness T3 region maps + skill read-first diet (`#1291`); dependabot `#1351` / `#1349`.
