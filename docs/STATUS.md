...
- planned-but-not-shipped concepts now explicitly tracked in roadmap docs include:
  - broader telemetry and release-gate follow-through (`#341`) _(historical — the release-gate/launch portion is **de-scoped** by the 2026-06-13 archive pivot; the telemetry event stream itself shipped opt-in/off-by-default — see below)_
