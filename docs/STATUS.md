...
Archive-pivot delivery wave (2026-06-13, **17 PRs merged** across Waves 0–2 plus 2 follow-on dependabot bumps `#1211`/`#1212`; full review gate per PR — 2 independent adversarial reviews, all-severity findings fixed, Gemini/Codex/Copilot bot threads resolved, fresh green CI + aging):
