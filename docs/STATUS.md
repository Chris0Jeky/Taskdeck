...
- capture inbox backend pipeline is partially shipped (`#200` to `#204`); remaining open dependencies are strict schema/prompt-version enforcement (`#205`), inbox/provenance UX slices (`#206` to `#209`), and end-to-end verification (`#210`)
