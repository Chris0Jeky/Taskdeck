...
Overnight substrate + correctness wave (2026-07-17, **8 PRs merged** — per-PR gate: independent adversarial review, all-severity findings fixed, required CI green; full backend suite reported 7223 passed / 0 failed / 1 skipped post-`#1373`):
...
- **Seeded follow-ups:** `#1376`, `#1379`, `#1380`, `#1382`, `#1383` (AuditRetention flake), `#1384`, `#1387`, `#1388`. **Still open — NOT shipped:** `#1381`, `#1385`, `#1386`, plus the standing human-gated holds `#1295` (deny-floor overlay), `#1337` (licensing pack), and `#1359`.
