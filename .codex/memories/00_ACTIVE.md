...
- Control-plane PRs (`.github/workflows/**`, `ci/**`, `scripts/ci/**`, runner or branch-protection paths, and the `ci/policy.v1.json` control paths) merge only after the maintainer's own review plus one fresh-context review (ADR-0066 amendment 2026-09-03). Green is not authority. **SC-10 is closed** (all twelve PRs in that queue merged 2026-09-06), but the 2026-09-06 walkthrough ruling q-1 = A delegated **those twelve named PRs only**; it did not lift the amendment for a new control-plane PR. Practice has diverged from that reading since 2026-09-09 and the divergence is an open human decision, `OUTSTANDING_TASKS.md` J.3 - read that row before opening or merging a control-plane PR.
- Codex review credits are restored: SC-9 closed 2026-09-06, and Codex code reviews have completed on merged PRs continuously since at least 2026-09-07T11:48Z (`#2774`, `#2796`, `#2805`, `#2833`, `#2850`, `#2865`, `#2868`, `#2911`). Global law 2g applies normally again: a clean Codex outcome is the whole review gate for documentation-only or very-low-risk work; other work still gets one fresh-context independent review. Do not spend a reviewer subagent on the assumption that the connector is unavailable.
