...
assert.equal(parseTaskdeckApiBaseUrl('http://127.0.0.42:5000').origin, 'http://127.0.0.42:5000');
...
assert.throws(() => parseTaskdeckApiBaseUrl('http://127.attacker.example'), /only allowed for localhost/i);
