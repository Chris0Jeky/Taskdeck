    ...
    affordances: [
      {
        ...
        precondition: 'seeded-board',
        consequence: { kind: 'response', method: 'GET', urlPattern: '/api/metrics/boards/{boardId}' },
        status: { activate: true },
      },
      {
      ...
      },
      {
        ...
        precondition: 'seeded-board',
        consequence: { kind: 'response', method: 'GET', urlPattern: '/api/metrics/boards/{boardId}/export' },
        status: { activate: true },
      },
    ],
  },
