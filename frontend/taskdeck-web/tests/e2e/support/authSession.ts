...
export async function attachSessionToPage(
  ...
  await page.addInitScript((initPayload: {
    ...
    // Paper is the product default. Specs that intentionally preserve frozen Legacy-DOM
    // coverage opt out explicitly. Conditional so it never clobbers a theme-specific value
