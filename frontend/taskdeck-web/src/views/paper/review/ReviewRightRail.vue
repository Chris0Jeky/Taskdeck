...
withDefaults(
  defineProps<{
    ...
    /** Settled records are inspectable, but no decision-key hints remain active. */
    readOnly?: boolean
  }>(),
  { applyPhase: 'approve', readOnly: false },
)
</script>
...
<template>
  <aside class="paper-review-right" data-testid="paper-review-right-rail">
    ...
    <ReviewKeysCard v-if="!readOnly" :apply-phase="applyPhase" />
  </aside>
</template>
