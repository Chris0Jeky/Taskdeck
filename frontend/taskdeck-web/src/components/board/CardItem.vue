...
<template>
  ...
  >
    <div
      ...
      class="td-card-drag-surface -m-1 rounded-md p-1 cursor-grab active:cursor-grabbing"
      draggable="true"
    >
      <!-- Blocked Badge -->
      ...
      <div class="flex items-start justify-between gap-2 mb-2">
        ...
        <button
          type="button"
          class="flex-shrink-0 rounded p-1 text-gray-400 hover:text-gray-700 hover:bg-gray-100"
          title="Drag Card"
