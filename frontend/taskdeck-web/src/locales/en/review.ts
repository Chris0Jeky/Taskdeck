...
export default {
  ...
  batchExecute: {
    ...
    nothingToApply: 'There is nothing approved to apply right now.',
    ...
    dialog: {
      title: 'Apply approved proposals?',
      description: 'Confirm apply for {count} approved proposal | Confirm apply for {count} approved proposals',
      body: 'Taskdeck will apply {count} already-approved proposal to its board. | Taskdeck will apply each of {count} already-approved proposals to its board.',
      partialWarning: 'Each proposal is applied on its own. Some can succeed while others fail, and nothing is rolled back.',
      cancel: 'Keep reviewing',
      confirm: 'Apply {count} proposal | Apply {count} proposals',
      receiptsTitle: 'What was applied',
      receiptsDescription: 'Result for {count} proposal | Results for {count} proposals',
      receiptSummary: 'Applied {applied} · skipped {skipped} · failed {failed}.',
      done: 'Close',
    },
  },
  batchApprove: {
