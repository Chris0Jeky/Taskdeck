...
public sealed class ContextFabricSettings
{
    ...
    /// wrote last. Nothing a user sees goes backwards at any point in that sequence, which is what
    /// the divergence guard and the reconcile pass exist to guarantee.
    /// </para>
    /// </summary>
