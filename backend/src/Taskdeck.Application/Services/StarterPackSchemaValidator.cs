...
/// <summary>
/// Validates the structural shape of a starter-pack manifest: required fields,
/// format constraints (slugs, semver, hex colors), duplicate detection within
/// individual collections, and contiguous column positions.
/// Does NOT validate cross-entity references (e.g. seed card -> column).
/// </summary>
public sealed class StarterPackSchemaValidator
{
    ...
    /// <summary>
    /// Runs schema/shape validation and returns the known label, column, and template
    /// names so the semantic validator can check cross-references.
    /// </summary>
    public StarterPackSchemaValidationOutput Validate(
...
/// <summary>
/// Output of schema validation: the sets of known names for cross-reference checking.
/// </summary>
