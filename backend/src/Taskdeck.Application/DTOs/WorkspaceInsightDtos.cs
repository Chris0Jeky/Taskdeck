...
public record WorkspaceMemoryDto(Guid Id, Guid BoardId, string Title, string Text, string OriginalText, string Status, bool Archived, int Revision, DateTimeOffset CreatedAt, IReadOnlyList<WorkspaceMemoryRevisionDto> History, string? OriginalEvidence);
