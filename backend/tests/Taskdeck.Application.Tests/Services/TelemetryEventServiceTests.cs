...
public class TelemetryEventServiceTests
{
    ...
    public void RecordEvent_ShouldStripTerminalControlsFromLoggedValues()
    {
        ...
        var evt = CreateValidEvent();
        evt.SessionId = "session \u001Bescape\u000Bvertical\u0085next\u009Bc1\u2028line\u2029paragraph\r\nsafe café ✓";
        evt.WorkspaceMode = "guided \u001Bescape\u000Bvertical\u0085next\u009Bc1\u2028line\u2029paragraph\r\nsafe café ✓";
        ...
        message.Should().Contain("session escapeverticalnextc1lineparagraphsafe café ✓");
        message.Should().Contain("guided escapeverticalnextc1lineparagraphsafe café ✓");
    }
}
