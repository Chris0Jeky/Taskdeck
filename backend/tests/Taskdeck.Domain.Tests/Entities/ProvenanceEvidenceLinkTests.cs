...
public class ProvenanceEvidenceLinkTests
{
    ...
    {
        var link = new ProvenanceEvidenceLink("InboxCapture", "cap-123", _fieldId);
    ...
    {
        var act = () => new ProvenanceEvidenceLink("", "cap-123", _fieldId);
    ...
    public void Constructor_ShouldThrow_WhenSourceTypeExceedsMaxLength()
    {
        ...
        var act = () => new ProvenanceEvidenceLink(longType, "cap-123", _fieldId);
    ...
    {
        var act = () => new ProvenanceEvidenceLink("InboxCapture", "", _fieldId);
    ...
    public void Constructor_ShouldThrow_WhenSourceIdExceedsMaxLength()
    {
        ...
        var act = () => new ProvenanceEvidenceLink("InboxCapture", longId, _fieldId);
    ...
    {
        var act = () => new ProvenanceEvidenceLink("InboxCapture", "cap-123", Guid.Empty);
    ...
    public void Constructor_ShouldThrow_WhenLabelExceedsMaxLength()
    {
        ...
        var act = () => new ProvenanceEvidenceLink("InboxCapture", "cap-123", _fieldId, label: longLabel);
    ...
    {
        var act = () => new ProvenanceEvidenceLink("InboxCapture", "cap-123", _fieldId, spanStart: -1);
    ...
    {
        var act = () => new ProvenanceEvidenceLink("InboxCapture", "cap-123", _fieldId, spanEnd: -1);
    ...
    {
        var act = () => new ProvenanceEvidenceLink("InboxCapture", "cap-123", _fieldId, spanStart: 20, spanEnd: 10);
    ...
    {
        var link = new ProvenanceEvidenceLink("InboxCapture", "cap-123", _fieldId, spanStart: 5, spanEnd: 5);
    ...
    {
        var link = new ProvenanceEvidenceLink("InboxCapture", "cap-123", _fieldId, spanStart: 10);
